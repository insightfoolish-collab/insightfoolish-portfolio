...
export default function Workspace() {
  ...
  function addPhotos(files: FileList | null) {
    ...
    setDrafts((current) => [...current, ...Array.from(files).map((file) => ({ id: crypto.randomUUID(), file, preview: URL.createObjectURL(file), project: "", word: file.name.replace(/\.[^.]+$/, ""), story: "", current: true }))]);
  }
